    ...
    <section id="about" className="section-padding bg-secondary/30">
      <div className="container">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          >
            <h3 className="content-heading mb-2">Bio</h3>
          ...
          >
            <h3 className="content-heading mb-6">Education</h3>
            
            <div className="mb-8 bg-card p-6 rounded-lg shadow-sm border border-highlight/20 hover:border-highlight/40 transition-colors">
              <h4 className="font-semibold text-lg">Bachelor of Engineering</h4>
              <p className="text-highlight">G. H. Raisoni College of Engineering, Nagpur</p>
              <p className="text-sm text-muted-foreground mt-1">2018 - 2022</p>
              <p className="mt-2"><span className="font-medium">CGPA:</span> 9.33</p>
            </div>
            
            <div className="bg-card p-6 rounded-lg shadow-sm border border-highlight/20 hover:border-highlight/40 transition-colors">
              <h4 className="font-semibold text-lg">Higher Secondary Certificate (HSC)</h4>
              <p className="text-highlight">Sri Chaitanya Junior College, Hyderabad</p>
